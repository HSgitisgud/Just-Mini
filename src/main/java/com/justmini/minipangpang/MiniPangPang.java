...
public class MiniPangPang extends JFrame {
    ...
    // private static final String FIXED_STONE_IMAGE_PATH = "/images/minipangpang/stone.png";
    ...
    private Timer timer;
    // private List<Point> fixedStonePositions = new ArrayList<>();
    ...
    public void refillGrid() {
        for (int j = 0; j < GRID_SIZE; j++) { // 열 단위로 처리
            int emptySlots = 0;
